...
#
########################################################################
#Author replies: The dimension problem was an issue that I remedied recently, but doesn't seem to have made it into this build version.*Ill do that for you now* The lengthy dialog messages and commenting in the program itself is intended to contextualize things for someone who wants to later modify certain parts of this for their own purposes. Additionally, I realize the main function is quite bulky but I felt for you to have a decent idea of the magnitutdes and purposes of the inputs, so as to not leave you at a loss of what to put in. 

# I also made such heavy use of comments throughout the program specifically for this review portion to make sure nothing was left unexplained.
