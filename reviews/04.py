...
########################################################################
#
# 1. The code mostly runs without any errors and produces a table and a graph. There were a few times when my result said that there was no data for my time period.
#
#
...
#
#
# 3. The code is readable. However it says that there are PEP-8 violations for your 5 functions you defined at the beginnning "E302 expected 2 blank lines, found 1". There are also some variable names and comments under your functions that are giving errors related to indentation. I think there just needs to be more spacing between your functions.
#
#
...
#
#
# 8. There are parts of the table that are unclear, specifically the the first and last velocities say N/A on the output. I believe you are still fixing those so it most likely just caused by that. The graph looks good.
#
#
########################################################################
